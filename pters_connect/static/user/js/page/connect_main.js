class ConnectMain extends DomController{
    ...
    draw_layout(install_target){
        ...
        let program_guide = CComp.container(/*type*/ "article", /*title*/ "", /*style*/ null, /*attr*/ {id:this.install_target.program_guide.replace(/#/, ''), class:"article_padding"});
        let magazine = CComp.container(/*type*/ "article", /*title*/ "", /*style*/ null, /*attr*/ {id:this.install_target.magazine.replace(/#/, ''), class:"article_padding"});
        let leading_partner_pro = CComp.container(/*type*/ "article", /*title*/ "", /*style*/ null, /*attr*/ {id:this.install_target.leading_partner_pro.replace(/#/, ''), class:"article_padding"});
    ...
    dom_search_box_title(){
        let title = CComp.text(/*title*/ "내 주변 <br>최고의 골프 코치님을 <br>만나보세요", /*style*/ {"font-size":"2.0em", "font-weight":"bold", "color":"var(--font-invisible)", "word-break":"keep-all"}, /*attr*/{});
