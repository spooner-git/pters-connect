...
class PAGEConnectCenterManage extends Component{
    ...
    _readMyCenters = () => {
        ...
        CFunc.ajaxGet(
            ...
            console.log(`성공: `);
            this.setState_myCenters(data.data.results);
        })
    }
    ...
    DOMCenterBasicInfo = () => {
        ...
        return <ListTile 
                    title={this.myCenters[0].name} 
                    subtitle={<div>
                                <div>{this.myCenters[0].address}</div>
                                <div>{this.myCenters[0].address}</div>
                            </div>} 
                    trailing={<Button style={{border:"0", fontSize:"25px", color:"#464646"}}>
                            ...
                            <section className="center_manage_section center_academy_info_wrap">
                                ...
                                <div>
                                    {   
                                        ...
                                        ?<div style={{textAlign:"center"}}><LoadingImg size="25px"></LoadingImg><p style={{margin:"0"}}>불러오는 중</p></div>
    ...
    render(){
        return(
            <div>
                {
                    this.myCenters == null
                    ?<div style={{textAlign:"center", height:"100vh", paddingTop:"50%"}}><LoadingImg size="25px"></LoadingImg><p style={{margin:"0"}}>불러오는 중</p></div>
                    :this.DOMCenterCard()
                }
            </div>
        )
